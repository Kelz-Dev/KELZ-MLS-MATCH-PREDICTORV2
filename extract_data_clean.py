...
print(latest.loc[["Toronto FC", "Nashville SC", "Vancouver Whitecaps"], ["date", "season", "conference", "season_points", "points", "position"]])
...
import joblib
joblib.dump({'latest': latest, 'rating': rating, 'feature_names': feature_names, 'features': features, 'conference': conference}, 'prediction_data.joblib')
